    ...
    <article className="min-h-screen py-4 sm:py-6 md:py-8 px-2 sm:px-4 relative">
      ...
      <div className="max-w-[1800px] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 md:gap-8 mb-6 sm:mb-8 relative">
          ...
          <motion.section
            className="relative rounded-3xl bg-card/40 backdrop-blur-2xl border border-border/50 shadow-2xl overflow-visible order-2 lg:order-1 ml-9 mr-9 flex-1 lg:flex-2"
